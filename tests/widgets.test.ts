...
test.describe('Widgets tests', () => {
  ...
  test("widgets - accordian test", async ({ page, accordianPage }) => {
    await page.goto("/");
    await accordianPage.goToTab(accordianPage.widgets_card, accordianPage.accordian_tab);
  ...
  test("widgets - auto complete test", async ({ page, autoCompletePage }) => {
    await page.goto("/");
    await autoCompletePage.goToTab(autoCompletePage.widgets_card, autoCompletePage.auto_complete_tab);
  ...
  test("widgets - date picker test", async ({ page, datePickerPage }) => {
    await page.goto("/");
    await datePickerPage.goToTab(datePickerPage.widgets_card, datePickerPage.date_picker_tab);
  ...
  test("widgets - slider test", async ({ page, sliderPage }) => {
    await page.goto("/");
    await sliderPage.goToTab(sliderPage.widgets_card, sliderPage.slider_tab);
  ...
  test("widgets - progress bar test", async ({ page, progressBarPage }) => {
    await page.goto("/");
    await progressBarPage.goToTab(progressBarPage.widgets_card, progressBarPage.progress_bar_tab);
  ...
  test("widgets - tabs test", async ({ page, tabsPage }) => {
    await page.goto("/");
    await tabsPage.goToTab(tabsPage.widgets_card, tabsPage.tabs_tab);
  ...
  test("widgets - tool tip test", async ({ page, toolTipsPage }) => {
    await page.goto("/");
    await toolTipsPage.goToTab(toolTipsPage.widgets_card, toolTipsPage.tool_tip_tab);
  ...
  test("widgets - menu test", async ({ page, menuPage }) => {
    await page.goto("/");
    await menuPage.goToTab(menuPage.widgets_card, menuPage.menu_tab);
  ...
  test("widgets - select menu test", async ({ page, selectMenuPage }) => {
    await page.goto("/");
    await selectMenuPage.goToTab(selectMenuPage.widgets_card, selectMenuPage.select_menu_tab);
