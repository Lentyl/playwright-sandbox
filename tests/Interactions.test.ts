...
test.describe('Interactions tests', () => {
  ...
  test("Interactions - selectable test", async ({ page, selectablePage }) => {
    await page.goto("/");
    await selectablePage.goToTab(selectablePage.interactions_card, selectablePage.selectable_tab);
  ...
  test("Interactions - resizable test", async ({ page, resizablePage }) => {
    await page.goto("/");
    await resizablePage.goToTab(resizablePage.interactions_card, resizablePage.resizable_tab);
  ...
  test("Interactions - droppable test", async ({ page, droppablePage }) => {
    await page.goto("/");
    await droppablePage.goToTab(droppablePage.interactions_card, droppablePage.droppable_tab);
